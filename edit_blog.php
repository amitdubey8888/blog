					...
					<div class="m-portlet__body">
						<div class="form-group m-form__group row">
							...
							<div class="col-lg-7 col-md-7 col-sm-12">
								<input type="text" class="form-control m-input" id="title" name="title" aria-describedby="emailHelp" placeholder="Enter post title" value="<?php if($row['title']){echo $row['title'];}?>">
							</div>
						</div>
						<div class="form-group m-form__group row">
							<label class="col-form-label col-lg-3 col-sm-12">
							...
							<div class="col-lg-7 col-md-7 col-sm-12">
								<textarea class="summernote" id="summernote"><?=$row['description']?></textarea>
							</div>
						</div>
						...
						<div class="form-group m-form__group row">
							...
							<strong><?php if($row['image']){echo $row['image'];}?></strong>
						</div>
					...
					$.ajax({
						...
						success: function(res){
							if(parseInt(res)==1){
								...
								alert('Sorry, Unable to update blog !');
							}
